...
const App: React.FC = () => {
    ...
    // 使用 Framer Motion 的 MotionValue 来处理高频鼠标位置更新，确保性能
    ...
    return (
        <div className="min-h-screen relative mesh-gradient overflow-x-hidden">
            {/* 全局背景装饰 */}
            ...
            <main className="relative z-10">
                {/* Hero Section - 包含聚光灯交互 */}
                <section
                    ref={heroRef}
                    onMouseMove={handleMouseMove}
                    className="relative min-h-screen flex flex-col justify-center px-6 pt-20 overflow-hidden group/hero"
                >
                    {/* 聚光灯图层 - 仅在 Hero Section 显示 */}
                    <motion.div
                        className="absolute inset-0 pointer-events-none z-0 transition-opacity duration-500 opacity-0 group-hover/hero:opacity-100"
